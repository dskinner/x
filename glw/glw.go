...
func (vert *VertexArray) Bind() {
	...
	ctx.VertexAttribPointer(vert.Attrib, vert.Size, gl.FLOAT, false, vert.Stride*4, vert.Offset*4)
}
...
func (tex Texture) Unbind() { ctx.BindTexture(gl.TEXTURE_2D, gl.Texture{Value: 0}) }
